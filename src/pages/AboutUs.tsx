  ...
  return (
    <div className="relative w-full min-h-screen bg-black font-sans flex flex-col overflow-hidden">
      ...
      >
        <Link
          to="/"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-black hover:bg-neutral-900 text-white font-semibold text-sm rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#1e3a8a]/30 hover:-translate-y-0.5 active:translate-y-0 border border-white/10 hover:border-[#1e3a8a]/50"
        >
      ...
      <div className="relative z-10 pt-6 md:pt-8 px-4 md:px-8 flex-shrink-0">
        <div className="max-w-6xl mx-auto text-center mb-2">
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-[#1e3a8a] max-w-2xl mx-auto px-4 py-2 rounded-full bg-white backdrop-blur-sm animate-text-blink"
          >
          ...
          <motion.div
            ...
            className="h-1 w-24 bg-[#1e3a8a] mx-auto mt-4 rounded-full"
          />
        </div>
      </div>
      ...
      <div className="relative w-full flex flex-col items-center justify-center px-4 py-8 md:py-10 flex-shrink-0 flex-1">
        ...
        <button
          ...
          className="absolute left-4 md:left-8 z-30 p-3 rounded-full bg-[#1e3a8a]/20 hover:bg-[#1e3a8a]/50 text-white hover:text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-110 active:scale-95 backdrop-blur-sm border border-[#1e3a8a]/30 group"
              ...
              return (
                ...
                >
                  ...
                  <div className={`relative w-60 h-72 md:w-72 md:h-80 rounded-3xl overflow-hidden group ${position === "center" && hasInitialized && isAnimating ? "animate-glow-in" : ""}`}>
                    ...
                    {position === "center" && (
                      <div className="absolute inset-0 border-2 border-[#1e3a8a]/40 rounded-3xl animate-pulse" />
                    )}
                  </div>
                </div>
              );
        ...
        <button
          onClick={handleNext}
          disabled={isAnimating}
          className="absolute right-4 md:right-8 z-30 p-3 rounded-full bg-[#1e3a8a]/20 hover:bg-[#1e3a8a]/50 text-white hover:text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-110 active:scale-95 backdrop-blur-sm border border-[#1e3a8a]/30 group"
            ...
            {teamMembers.map((_, index) => (
              <button
                ...
                className={`transition-all duration-500 ${
                  index === currentIndex
                    ? "w-6 h-1.5 bg-[#1e3a8a] rounded-full"
                    : "w-1.5 h-1.5 bg-[#1e3a8a]/30 hover:bg-[#1e3a8a]/60 rounded-full"
                }`}
      ...
      <motion.div
        ...
        className="relative z-10 py-8 md:py-10 px-4 md:px-8 border-t border-[#1e3a8a]/20 backdrop-blur-sm flex-shrink-0 w-full"
      >
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
            <div className="text-center md:text-left">
              <p className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white text-sm text-[#1e3a8a] mb-1 tracking-wide font-extrabold"><img src="/eduxam-logo.png" alt="EduXam" className="w-5 h-5 rounded object-contain" />EduXam</p>
            ...
            <div className="text-center md:text-right">
              <p className="text-sm text-orange-500 mb-1 uppercase tracking-wide font-extrabold">Garden City University</p>
