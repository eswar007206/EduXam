...
interface SubjectReport {
  subject_id: string;
  subject_name: string;
  exam_type: SubmissionRow["exam_type"];
  ...
  for (const [studentId, { username, subjectMap }] of studentMap) {
    ...
    for (const [subjectId, subs] of subjectMap) {
      ...
      subjects.push({
        ...
        exam_type: subs[0].exam_type ?? "main",
        submissions: subs,
        ...
        >
          <div className="bg-white border-2 border-gray-100 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-extrabold text-[#071952]">
                  {totalStudents}
                </p>
          ...
          {filteredReports.map((student, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white border-2 border-gray-100 rounded-2xl overflow-hidden transition-all duration-200 hover:shadow-lg hover:border-black/20"
              >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-[#071952] truncate">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {student.pendingCount > 0 && (
                      <span className="flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-gray-50 text-black border border-black/20">
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3 px-4 py-3 bg-gray-50">
                              ...
                              <div className="flex items-center gap-2 flex-1 min-w-0">
                                <h4 className="font-semibold text-sm text-[#071952] truncate">
                                  {subject.subject_name}
                                </h4>
                                <ExamTypeBadge examType={subject.exam_type ?? "main"} compact />
                              </div>
                            ...
                            <div className="divide-y divide-gray-100">
                              {subject.submissions.map((sub) => (
                                <button
                                  ...
                                  className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[#071952] hover:text-white transition-colors text-left group"
                                >
                                  ...
                                  <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-black transition-colors shrink-0" />
                                </button>
                              ))}
                            </div>
                          </div>
