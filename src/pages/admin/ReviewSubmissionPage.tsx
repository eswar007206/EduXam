    ...
    <div className="max-w-5xl mx-auto">
      ...
      {submission.evaluation_type === 'ai_teacher' && (
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex items-center gap-3 p-4 rounded-2xl bg-blue-50 border-2 border-blue-200 mb-6"
        >
          <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center shrink-0">
            <Sparkles className="w-5 h-5 text-blue-600" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-blue-800">AI Pre-Evaluated</p>
            <p className="text-xs text-blue-600">
              Marks and feedback below were generated by AI. Review and adjust as needed before submitting.
            </p>
          </div>
        </motion.div>
      )}
            ...
            return (
              ...
              >
                  ...
                  {isMCQ ? (
                    ...
                    <div className="rounded-xl border border-gray-200 overflow-hidden">
                      ...
                      <div className="flex items-center justify-between px-4 py-2 bg-zinc-800 border-b border-zinc-700">
                        <span className="text-xs px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 font-mono uppercase">
                        ...
                        {studentTextAnswer && (
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white text-xs font-medium rounded-lg transition-colors"
                          >
                      ...
                      {codeRunState[question.id] && !codeRunState[question.id].running && (
                        <div className="border-t border-zinc-700 bg-zinc-950 p-4">
                          ...
                          {codeRunState[question.id].stderr ? (
                            <pre className="text-sm text-red-400 font-mono whitespace-pre-wrap mt-1">
                              {codeRunState[question.id].stderr}
                            </pre>
                          ) : null}
                    ...
                    return (
                      <div className="space-y-3">
                        ...
                        {codeData && (
                          <div className="rounded-xl border-2 border-[#1e3a8a]/20 overflow-hidden">
                            <div className="flex items-center gap-2 px-4 py-2 border-b border-[#1e3a8a]/20" style={{ backgroundColor: '#1e3a8a' }}>
                ...
                {submission.evaluation_type === 'ai_teacher' && submission.evaluation_data && (() => {
                  ...
                  return (
                    <div className="p-3 rounded-lg bg-blue-50 border border-blue-200 mb-1">
                      <div className="flex items-center gap-2 mb-1">
                        <Sparkles className="w-3.5 h-3.5 text-blue-500" />
                        <span className="text-xs font-semibold text-blue-700">AI Feedback</span>
                        <span className="text-xs text-blue-500 ml-auto flex items-center gap-2">
                          ...
                          AI awarded: {qFeedback.marksAwarded}/{qFeedback.maxMarks}
                        </span>
                      </div>
                      <textarea
                        ...
                        rows={2}
                        className="w-full text-xs text-blue-600 bg-transparent border-0 border-t border-blue-200 mt-1 pt-1 resize-none focus:outline-none focus:ring-0 placeholder:text-blue-400"
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-20 px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-gray-900 text-sm text-center focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent"
                      placeholder="0"
                    />
                  ...
                  <button
                    ...
                    className="ml-auto flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium bg-[#1e3a8a] text-white hover:bg-[#162d6e] transition-colors disabled:opacity-50"
                  >
                    {feedbackSaving[question.id] ? (
                      <Loader2 className="w-3 h-3 animate-spin" />
      ...
      >
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent text-sm resize-none"
          placeholder="Add overall feedback for the student..."
        />

        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
          <div className="text-sm text-gray-500">
            Total: <span className="font-bold text-[#1e3a8a]">{totalMarksAwarded}</span> /{" "}
            {totalMaxMarks} marks
            {totalMaxMarks > 0 && (
          ...
          <div className="flex items-center gap-2">
            {submission.status === "evaluated" && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition-colors text-sm font-medium"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1e3a8a] text-white rounded-xl hover:bg-[#162d6e] transition-colors text-sm font-semibold disabled:opacity-50 shadow-md shadow-[#1e3a8a]/25"
            >
              {saving ? (
