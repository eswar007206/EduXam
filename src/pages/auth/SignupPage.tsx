...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div
        ref={leftSectionRef}
        className="relative z-10 w-full lg:w-1/2 flex items-start pt-20 lg:items-center lg:pt-14 justify-center p-4 sm:p-6 lg:p-8 overflow-y-auto"
      >
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="relative group">
                  <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-white/40 lg:text-gray-400 transition-colors group-focus-within:text-black" />
                  <input
                    type="text"
                    value={username}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <motion.button
                    ...
                    className={`relative p-3 sm:p-4 rounded-xl border-2 text-left cursor-pointer overflow-hidden transition-all duration-300 ${role === "student"
                      ? "border-black/20 ring-4 ring-blue-500/30 shadow-lg shadow-blue-500/25 bg-gray-500/10 lg:bg-gray-50"
