      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-3 py-2 bg-background border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-black resize-none"
            ...
            {(["a", "b", "c", "d"] as const).map((key) => (
              <div key={key} className="flex items-center gap-3">
                ...
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-background border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-black"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  type="button"
                  onClick={addTestCase}
                  className="flex items-center gap-1 text-xs px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-black/10 text-black dark:text-black hover:bg-black/80 dark:hover:bg-black/20 transition"
                >
                  <Plus size={14} />
                  Add Test Case
                </button>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="text-sm font-medium bg-transparent border-b border-transparent hover:border-border focus:border-black focus:outline-none text-foreground"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <textarea
                          ...
                          rows={2}
                          className="w-full px-2.5 py-1.5 bg-background border border-border rounded-lg text-foreground text-sm font-mono focus:outline-none focus:ring-2 focus:ring-black resize-none"
                          placeholder="e.g. 5 3"
                        />
                      </div>
                      <div>
        ...
        <div className="flex gap-3 pt-4">
          <button
            onClick={() => navigate(`/teacher/subjects/${subjectId}`)}
            className="px-6 py-2 border border-border rounded-lg text-foreground hover:bg-[#071952] hover:text-white transition text-sm"
          >
            Cancel
          </button>
          <button
            ...
            className="px-6 py-2 bg-[#071952] text-white rounded-lg hover:bg-[#071952]/90 transition text-sm font-medium disabled:opacity-50 flex items-center gap-2"
          >
