    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-white/10">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-[10px] font-medium text-[#1e3a8a] bg-[#1e3a8a]/20 px-1.5 py-0.5 rounded">
                Teacher Portal
              </span>
            </div>
          </div>
        ...
        <nav className="flex-1 p-4 space-y-1">
          <NavLink to="/admin/dashboard" className={linkClass} onClick={onToggle}>
            <LayoutDashboard className="w-4 h-4" />
            Dashboard
          </NavLink>
          <NavLink to="/admin/subjects" className={linkClass} onClick={onToggle}>
