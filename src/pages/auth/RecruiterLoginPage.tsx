...
import { Briefcase, Loader2, Mail, Lock, Eye, EyeOff, ArrowRight, ArrowLeft } from "lucide-react";
  ...
  useEffect(() => {
    if (!isLoading && isAuthenticated && profile) {
      if (profile.role === "recruiter") {
        ...
        setError("This page is for recruiters only. Use the appropriate login for your role.");
      }
    }
      ...
      <div className="relative z-10 w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        >
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 lg:p-8 shadow-2xl lg:bg-white lg:border-gray-200 lg:backdrop-blur-none lg:shadow-xl">
            ...
            <h1 className="text-2xl font-bold text-white lg:text-[#071952]">Recruiter Login</h1>
            <p className="text-white/70 lg:text-gray-500 text-sm mt-1.5">
              Sign in to access the recruiter portal
            </p>
            ...
            <p className="text-center text-xs text-white/50 lg:text-gray-500 mt-4">
              ...
              <Link to="/recruiterauth/signup" className="text-black font-medium hover:underline">Create recruiter account</Link>
            </p>
            <p className="text-center text-xs text-white/50 lg:text-gray-500 mt-1">
              ...
              {" · "}
              Teacher? <Link to="/teacherauth" className="text-black font-medium hover:underline">Log in here</Link>
            </p>
          </div>
        </motion.div>
      </div>
