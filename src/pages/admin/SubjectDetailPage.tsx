  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <button
          onClick={() => navigate(`/admin/subjects/${subjectId}/questions/new?category=${activeCategory.key}`)}
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent text-sm"
        />
        {searchQuery && (
          <button
            onClick={() => {
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-border rounded-lg text-foreground hover:bg-muted transition text-sm"
                >
                  Cancel
                </button>
                <button
            ...
            {questions.map((q, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    onClick={() => navigate(`/admin/subjects/${subjectId}/questions/${q.id}`)}
                    className="p-2 text-muted-foreground hover:text-[#1e3a8a] transition rounded-lg hover:bg-[#1e3a8a]/10"
                  >
                    <Pencil className="w-4 h-4" />
                  </button>
                  <button
                    onClick={() => setDeleteId(q.id)}
                    className="p-2 text-muted-foreground hover:text-red-500 transition rounded-lg hover:bg-red-500/10"
                  >
            ...
            <div className="flex items-center justify-between mt-6 pt-4 border-t border-border">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={page === 0}
                  className="p-2 rounded-lg border border-border text-foreground hover:bg-muted transition disabled:opacity-30"
                >
