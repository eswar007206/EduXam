  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <span className="px-2.5 py-1 rounded-md bg-[#1e3a8a]/10 text-[#1e3a8a] text-xs font-semibold uppercase tracking-wide">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#1e3a8a] text-white text-sm font-medium hover:bg-[#162d6e] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {isRunning ? (
              <Loader2 size={14} className="animate-spin" />
            ) : (
                    ...
                    {!tc.is_hidden && (
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        <div>
                          ...
                          <pre className="text-xs font-mono bg-zinc-100 dark:bg-zinc-800 rounded p-1.5 whitespace-pre-wrap">
                            {tc.input || "(empty)"}
                          </pre>
                        </div>
                        <div>
                        ...
                        {result && !result.passed && (
                          <div className="col-span-2">
                            ...
                            <pre className="text-xs font-mono bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 rounded p-1.5 whitespace-pre-wrap">
