...
/**
 * Get all teachers for the Find Teachers page.
 * Returns every teacher profile (regardless of subject count) so students can
 * discover and enroll with any teacher.
 */
